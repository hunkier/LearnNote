package cn.hunk.learn.web.eg.servlet;

import cn.hunk.learn.web.eg.entity.Admin;
import cn.hunk.learn.web.eg.exception.UserExistException;
import cn.hunk.learn.web.eg.exception.UserExistException;
import cn.hunk.learn.web.eg.service.IAdminService;
import cn.hunk.learn.web.eg.service.impl.AdminService;
import cn.hunk.learn.web.eg.util.WebUtils;
...
public class AdminServlet extends HttpServlet {
    ...
    private void out(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        if (null!=session){
            ...
            List<Admin> onlineList = (List<Admin>)getServletContext().getAttribute("onlineList");
