package cn.hunkier.spring.data.mybatis.mapper;
...
public interface CoffeeMapper {
     ...
     *
     * @mbg.generated Mon Aug 26 14:24:20 CST 2019
     */
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=cn.hunkier.spring.data.mybatis.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("cn.hunkier.spring.data.mybatis.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=cn.hunkier.spring.data.mybatis.handler.MoneyTypeHandler},",
