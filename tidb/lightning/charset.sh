...
find /tmp/test -type f | xargs grep 'utf8_bin' | awk -F: '{print $1}' | xargs sed -i "s|utf8_bin|utf8mb4_bin|g"

find /tmp/test -type f | xargs grep 'utf8_general_ci' | awk -F: '{print $1}' | xargs sed -i "s|utf8_general_ci|utf8mb4_bin|g"
